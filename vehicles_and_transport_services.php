...
<body>
	...
	<br /><br /><br />
		...
		<div id="wrapper2">
			<h3>Vehicles and Transport Services <?php echo $in_region; ?></h3>

		<div id="category_listings">
			<?php
				echo $removed;
				$manage_db = new manage_db();
				$query_category = $manage_db->return_query("SELECT * FROM categories WHERE category='vehicles and transport services'");
